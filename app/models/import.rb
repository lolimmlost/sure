class Import < ApplicationRecord
  ...
  TYPES = %w[TransactionImport TradeImport AccountImport MintImport CategoryImport RuleImport PdfImport QifImport SureImport BuddyImport FidelityImport].freeze
